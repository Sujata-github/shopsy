...
const ImageList = [
  {
    ...
    description:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit laboriosam recusandae ipsa maiores nulla sequi tenetur blanditiis perferendis. Dicta, eaque!'
  },
  {
    id: 2,
    img: Image2,
      ...
      <div className='container pb-8 sm:pb-0 '>
        <Slider {...settings}>
          {ImageList.map(data => (
            ...
            sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto'
                    />
                  </div>
                </div>
              </div>
